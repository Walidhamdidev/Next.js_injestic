export default function TermsOfService({ shopify_store_founder }) {
  return (
    <div className="px-20 py-20 leading-loose text-lg container mx-auto">
      OVERVIEW This website is operated by {shopify_store_founder}. Throughout
      the site, the terms “we”, “us” and “our” refer to {shopify_store_founder}.
      {shopify_store_founder} offers this website, including all information,
      ...
      added to the current store shall also be subject to the Terms of Service.
      ...
      posting of any changes constitutes acceptance of those changes. Our store
      is hosted on Shopify Inc. They provide us with the online e-commerce
      platform that allows us to sell our products and services to you. SECTION
      ...
      Service, violate any laws in your jurisdiction (including but not limited
      to copyright laws). You must not transmit any worms or viruses or any code
      of a destructive nature. A breach or violation of any of the Terms will
      result in an immediate termination of your Services. SECTION 2 - GENERAL
      CONDITIONS We reserve the right to refuse service to anyone for any reason
      at any time. You understand that your content (not including credit card
      ...
      case shall {shopify_store_founder}, our directors, officers, employees,
      ...
      {shopify_store_founder} and our parent, subsidiaries, affiliates,
      partners, officers, directors, agents, contractors, licensors, service
      providers, subcontractors, suppliers, interns and employees, harmless from
      any claim or demand, including reasonable attorneys’ fees, made by any
      third-party due to or arising out of your breach of these Terms of Service
      or the documents they incorporate by reference, or your violation of any
      law or the rights of a third-party. SECTION 15 - SEVERABILITY In the event
...
export function getStaticProps() {
  return {
    props: {
      shopify_store_founder: process.env.NEXT_PUBLIC_SHOPIFY_STORE_FOUNDER,
    },
  };
}
