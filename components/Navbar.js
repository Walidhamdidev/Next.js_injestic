...
export const Navbar = () => {
  return (
    <nav className="bg-white border-gray-200  px-2 sm:px-4 py-4 rounded dark:bg-gray-800">
        ...
        >
          <ul className="flex flex-col mt-4 md:flex-row md:space-x-10 md:mt-0 md:text-sm md:font-medium">
            <li>
              <Link href="/">
                <a
                  className="block py-2 pr-2 pl-3 text-lg text-white bg-blue-700 rounded md:bg-transparent md:text-blue-400 md:p-0 dark:text-white"
                  aria-current="page"
                >
                  Home
                </a>
